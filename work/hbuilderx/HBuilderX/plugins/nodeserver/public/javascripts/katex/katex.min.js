function hxLog(type, message, ...optionalParams){
    return;
    if (type === 'log') {
    ...
    return (function () {
                ...
                if (('function' == typeof o && (o = o(e, t, r)), o && 'ignore' !== o)) {
                    ...
                    'warn' === o
                        ? 'undefined' != typeof console &&
                          hxLog('warn', "LaTeX-incompatible input and strict mode is set to 'warn': " + t + ' [' + e + ']')
                        : 'undefined' != typeof console &&
                          hxLog('warn',
        ...
        function N(e, t, r) {
            ...
            let n = e.charCodeAt(0),
                o = T[t][n];
            if ((!o && e[0] in C && ((n = C[e[0]].charCodeAt(0)), (o = T[t][n])), o || 'text' !== r || (S(n) && (o = T[t][77])), o))
        ...
        class O {
            ...
            havingBaseStyle(e) {
                ...
                return this.size === t && this.textSize === O.BASESIZE && this.style === e ? this : this.extend({ style: e, size: t });
            }
            havingBaseSizing() {
                let e;
        ...
        const re = { bin: 1, close: 1, inner: 1, open: 1, punct: 1, rel: 1 },
            ne = { 'accent-token': 1, mathord: 1, 'op-token': 1, spacing: 1, textord: 1 },
            oe = { math: {}, text: {} };
        var se = oe;
        ...
        const Be = [
            ...
            qe = function (e, t, r, n, o) {
                ...
                if (((e = s.value), i)) {
                    ...
                    ('undefined' != typeof console &&
                        hxLog('warn', "No character metrics for '" + e + "' in style '" + t + "' and mode '" + r + "'"),
            ...
            Le = function (e, t, r) {
                ...
                return (
                    (n = 'textbf' === t && 'textit' === r ? 'BoldItalic' : 'textbf' === t ? 'Bold' : 'textit' === t ? 'Italic' : 'Regular'),
                    o + '-' + n
                );
            },
            De = {
            ...
            makeOrd: function (e, t, r) {
                ...
                if (l) {
                    ...
                    if ('boldsymbol' === l) {
                        ...
                        a
                            ? ((e = De[l].fontName), (n = [l]))
                            : ((e = Le(l, t.fontWeight, t.fontShape)), (n = [l, t.fontWeight, t.fontShape]));
        ...
        const Ke = function (e) {
            ...
            rt = { display: w.DISPLAY, text: w.TEXT, script: w.SCRIPT, scriptscript: w.SCRIPTSCRIPT },
            nt = {
                mord: 'mord',
                mop: 'mop',
                mbin: 'mbin',
        ...
        const vt = function (e, t, r) {
                if (1 === e.length) {
                    const n = St(e[0], t);
                    return (
                        r && n instanceof dt && 'mo' === n.type && (n.setAttribute('lspace', '0em'), n.setAttribute('rspace', '0em')),
                        [n]
                    );
                }
                const n = [];
        ...
        var Nt = function (e, t, r, n, o) {
                ...
                if (/fbox|color|angl/.test(t)) {
                    ...
                    const e = [];
                    (/^[bx]cancel$/.test(t) && e.push(new ee({ x1: '0', y1: '0', x2: '100%', y2: '100%', 'stroke-width': '0.046em' })),
                        /^x?cancel$/.test(t) && e.push(new ee({ x1: '0', y1: '100%', x2: '100%', y2: '0', 'stroke-width': '0.046em' })));
            ...
            It = function (e, t) {
                const {
                    ...
                    if (l.contains(['widehat', 'widecheck', 'widetilde', 'utilde'], n)) {
                        ...
                        const h = new Q(a),
                            c = new J([h], { width: '100%', height: F(l), viewBox: '0 0 ' + r + ' ' + i, preserveAspectRatio: 'none' });
        ...
        $e({
            ...
            htmlBuilder(e, t) {
                ...
                (o.classes.push(s + '-arrow-pad'),
                    e.below &&
                        ((n = t.havingStyle(r.sub())), (i = Pe.wrapFragment(ct(e.below, n, t), t)), i.classes.push(s + '-arrow-pad')));
                const a = It(e, t),
            ...
            return (
                'minner' === e.mclass
                    ...
                    : 'mord' === e.mclass
                      ...
                      : (e.isCharacterBox ? ((r = n[0]), (r.type = 'mo')) : (r = new ft.MathNode('mo', n)),
                        'mbin' === e.mclass
        ...
        $e({
            ...
            handler(e, t) {
                let { parser: r, funcName: n } = e;
                const o = t[0];
                return { type: 'mclass', mode: r.mode, mclass: 'm' + n.slice(5), body: Je(o), isCharacterBox: l.isCharacterBox(o) };
            },
            htmlBuilder: Ft,
            mathmlBuilder: Gt,
        });
        ...
        ($e({
            ...
            handler(e, t) {
                let { parser: r } = e;
                return { type: 'mclass', mode: r.mode, mclass: Ut(t[0]), body: Je(t[1]), isCharacterBox: l.isCharacterBox(t[1]) };
            },
        }),
            $e({
                type: 'mclass',
        ...
        const $t = {
            ...
            Kt = (e, t, r, n) => {
                ...
                (null == o && ((r.noexpand = !0), (o = { tokens: [r], numArgs: 0, unexpandable: !e.gullet.isExpandable(r.text) })),
        ...
        ($e({
            ...
            handler(e) {
                ...
                const o = t.fetch();
                if ($t[o.text])
                    return (('\\global' !== r && '\\\\globallong' !== r) || (o.text = $t[o.text]), Rt(t.parseFunction(), 'internal'));
            ...
            $e({
                ...
                handler(e) {
                    ...
                    return (
                        ...
                        t.gullet.macros.set(s, { tokens: h, numArgs: a, delimiters: l }, r === $t[r]),
        ...
        const Jt = function (e, t, r) {
            ...
            rr = function (e, t, r) {
                ...
                return { type: 'elem', elem: Pe.makeSpan(['delimsizinginner', n], [Pe.makeSpan([], [Pe.makeSymbol(e, t, r)])]) };
            },
            nr = function (e, t, r) {
                            ...
                            : '\\Updownarrow' === e
                              ...
                              : l.contains(sr, e)
                                ...
                                : l.contains(ir, e)
                                  ...
                                  : '[' === e || '\\lbrack' === e
                                    ? ((i = '\u23a1'), (h = '\u23a2'), (c = '\u23a3'), (u = 'Size4-Regular'), (m = 'lbrack'), (p = 667))
                                    : ']' === e || '\\rbrack' === e
                                      ? ((i = '\u23a4'), (h = '\u23a5'), (c = '\u23a6'), (u = 'Size4-Regular'), (m = 'rbrack'), (p = 667))
                                      : '\\lfloor' === e || '\u230a' === e
                                        ? ((h = i = '\u23a2'), (c = '\u23a3'), (u = 'Size4-Regular'), (m = 'lfloor'), (p = 667))
                                        : '\\lceil' === e || '\u2308' === e
                                          ? ((i = '\u23a1'), (h = c = '\u23a2'), (u = 'Size4-Regular'), (m = 'lceil'), (p = 667))
                                          : '\\rfloor' === e || '\u230b' === e
                                            ? ((h = i = '\u23a5'), (c = '\u23a6'), (u = 'Size4-Regular'), (m = 'rfloor'), (p = 667))
                                            : '\\rceil' === e || '\u2309' === e
                                              ? ((i = '\u23a4'), (h = c = '\u23a5'), (u = 'Size4-Regular'), (m = 'rceil'), (p = 667))
                                              : '(' === e || '\\lparen' === e
                                                ? ((i = '\u239b'),
                                                  (h = '\u239c'),
                                                  (c = '\u239d'),
            ...
            hr = function (e, t, r, n, o) {
                const s = (function (e, t, r) {
                    ...
                    i = new Q(e, s),
                    a = new J([i], { width: '400em', height: F(t), viewBox: '0 0 400000 ' + r, preserveAspectRatio: 'xMinYMin slice' });
            ...
            function w() {
                y &&
                    (e.gullet.macros.get('\\df@tag')
                        ? (y.push(e.subparse([new Ir('\\df@tag')])), e.gullet.macros.set('\\df@tag', void 0, !0))
        ...
        const Dr = function (e, t) {
                ...
                for (o = 0, A = 0; o < a || A < S.length; ++o, ++A) {
                    ...
                    for (; 'separator' === c.type; ) {
                        if (
                            (p || ((z = Pe.makeSpan(['arraycolsep'], [])), (z.style.width = F(t.fontMetrics().doubleRuleSep)), M.push(z)),
                    ...
                    (o > 0 || e.hskipBeforeAndAfter) &&
                        ...
                        0 !== i && ((z = Pe.makeSpan(['arraycolsep'], [])), (z.style.width = F(i)), M.push(z)));
                    let d = [];
                    for (r = 0; r < s; ++r) {
                        const e = h[r],
                            t = e[o];
                    ...
                    ((d = Pe.makeVList({ positionType: 'individualShift', children: d }, t)),
            ...
            Pr = function (e, t) {
                ...
                return (
                    ...
                    '' !== a && ((s = new ft.MathNode('menclose', [s])), s.setAttribute('notation', a.trim())),
                    e.arraystretch && e.arraystretch < 1 && ((s = new ft.MathNode('mstyle', [s])), s.setAttribute('scriptlevel', '1')),
                    s
                );
            },
            Fr = function (e, t) {
        ...
        (Br({
            ...
            Br({
                ...
                handler(e, t) {
                    ...
                    if (((o = Er(e.parser, o, 'script')), o.body.length > 0 && o.body[0].length > 1))
            ...
            Br({
                ...
                handler(e) {
                    Hr(e);
                    const t = { autoTag: Or(e.envName), emptySingleRow: !0, singleRow: !0, maxNumCols: 1, leqno: e.parser.settings.leqno };
                    return Er(e.parser, t, 'display');
                },
                htmlBuilder: Dr,
                mathmlBuilder: Pr,
        ...
        ($e({
            ...
            $e({
                ...
                handler: (e, t) => {
                    ...
                    return { type: 'font', mode: s, font: 'math' + n.slice(1), body: { type: 'ordgroup', mode: r.mode, body: i } };
                },
                htmlBuilder: Ur,
                mathmlBuilder: Yr,
            }));
        const Wr = (e, t) => {
            ...
            _r = (e, t) => {
                ...
                if (
                    (e.hasBarLine
                        ? (e.barSize
                              ? ((h = P(e.barSize, t)), (l = Pe.makeLineSpan('frac-line', t, h)))
                ...
                return (
                    ...
                    (f =
                        null == e.leftDelim
                            ? ht(t, ['mopen'])
                            : wr.customSizedDelim(e.leftDelim, g, !0, t.havingStyle(r), e.mode, ['mopen'])),
                    (b = e.continued
                        ? Pe.makeSpan([])
                        : null == e.rightDelim
                          ? ht(t, ['mclose'])
                          : wr.customSizedDelim(e.rightDelim, g, !0, t.havingStyle(r), e.mode, ['mclose'])),
        ...
        ($e({
            ...
            $e({
                ...
                handler(e, t) {
                    ...
                    return { type: 'infix', mode: r.mode, replaceWith: '\\\\abovefrac', size: Rt(t[0], 'size').value, token: o };
                },
            }),
            $e({
                type: 'genfrac',
        ...
        const Kr = (e, t) => {
            ...
            let n, o;
            'supsub' === e.type
                ? ((n = e.sup ? ct(e.sup, t.havingStyle(r.sup()), t) : ct(e.sub, t.havingStyle(r.sub()), t)),
        ...
        ($e({
            ...
            $e({
                ...
                handler: (e, t) => {
                    ...
                    return r.settings.isTrusted(l) ? { type: 'html', mode: r.mode, attributes: h, body: Je(a) } : r.formatUnsupportedCmd(o);
                },
                htmlBuilder: (e, t) => {
                    const r = ot(e.body, t, !1),
                        n = ['enclosing'];
        ...
        ($e({
            ...
            $e({
                ...
                htmlBuilder: (e, t) => {
                    let r;
                    'clap' === e.alignment
                        ? ((r = Pe.makeSpan([], [ct(e.body, t)])), (r = Pe.makeSpan(['inner'], [r], t)))
        ...
        $e({
            ...
            handler: (e, t) => {
                let { parser: r } = e;
                return { type: 'mathchoice', mode: r.mode, display: Je(t[0]), text: Je(t[1]), script: Je(t[2]), scriptscript: Je(t[3]) };
            },
            htmlBuilder: (e, t) => {
                const r = Qr(e, t),
                    n = ot(r, t, !1);
        ...
        const en = (e, t, r, n, o, s, i) => {
            ...
            rn = (e, t) => {
                ...
                return (
                    ...
                    s ? en(a, r, n, t, i, m, c) : (c && ((a.style.position = 'relative'), (a.style.top = F(c))), a)
                );
            },
            nn = (e, t) => {
                let r;
        ...
        ($e({
            ...
            handler: (e, t) => {
                let { parser: r, funcName: n } = e,
                    o = n;
                return (1 === o.length && (o = on[o]), { type: 'op', mode: r.mode, limits: !0, parentIsSupSub: !1, symbol: !0, name: o });
            },
            htmlBuilder: rn,
            mathmlBuilder: nn,
        }),
        ...
        const an = (e, t) => {
            let r,
                ...
                i = !1;
            if (
                ('supsub' === e.type ? ((r = e.sup), (n = e.sub), (o = Rt(e.base, 'operatorname')), (i = !0)) : (o = Rt(e, 'operatorname')),
                o.body.length > 0)
            ) {
        ...
        ($e({
            ...
            $e({
                ...
                htmlBuilder: (e, t) => {
                    ...
                    return (
                        (r = Pe.makeVList({ positionType: 'firstBaseline', children: [{ type: 'elem', elem: r }] }, t)),
                ...
                htmlBuilder(e, t) {
                    ...
                    if (e.index) {
                        const r = t.havingStyle(w.SCRIPTSCRIPT),
                            ...
                            s = Pe.makeVList({ positionType: 'shift', positionData: -o, children: [{ type: 'elem', elem: n }] }, t),
        ...
        $e({
            ...
            mathmlBuilder(e, t) {
                const r = cn[e.style],
                    ...
                    i = { display: ['0', 'true'], text: ['0', 'false'], script: ['1', 'false'], scriptscript: ['2', 'false'] }[e.style];
        ...
        (Ze({
            ...
            mathmlBuilder(e, t) {
                let r,
                    n,
                    o = !1;
                (e.base && 'horizBrace' === e.base.type && ((n = !!e.sup), n === e.base.isOver && ((o = !0), (r = e.base.isOver))),
        ...
        Ze({
            ...
            mathmlBuilder(e, t) {
                const r = new ft.MathNode('mtable', [
                    new ft.MathNode('mtr', [dn(), new ft.MathNode('mtd', [kt(e.body, t)]), dn(), new ft.MathNode('mtd', [kt(e.tag, t)])]),
                ]);
                return (r.setAttribute('width', '100%'), r);
            },
        });
        const gn = { '\\text': void 0, '\\textrm': 'textrm', '\\textsf': 'textsf', '\\texttt': 'texttt', '\\textnormal': 'textrm' },
        ...
        const Rn = F(T['Main-Regular']['T'.charCodeAt(0)][1] - 0.7 * T['Main-Regular']['A'.charCodeAt(0)][1]);
            ...
            formLigatures(e) {
                ...
                for (let r = 0; r < t; ++r) {
                    ...
                    ('-' === o &&
                        '-' === e[r + 1].text &&
                        (r + 1 < t && '-' === e[r + 2].text
                            ? (e.splice(r, 3, { type: 'textord', mode: 'text', loc: qr.range(n, e[r + 2]), text: '---' }), (t -= 2))
                            : (e.splice(r, 2, { type: 'textord', mode: 'text', loc: qr.range(n, e[r + 1]), text: '--' }), (t -= 1))),
                        ("'" !== o && '`' !== o) ||
                            e[r + 1].text !== o ||
                            (e.splice(r, 2, { type: 'textord', mode: 'text', loc: qr.range(n, e[r + 1]), text: o + o }), (t -= 1)));
                }
            }
            parseSymbol() {
                const e = this.fetch();
        ...
        'undefined' != typeof document &&
            ...
            ('undefined' != typeof console &&
                hxLog('warn', "Warning: KaTeX doesn't work in quirks mode. Make sure your website has a suitable doctype."),
            (Un = function () {
